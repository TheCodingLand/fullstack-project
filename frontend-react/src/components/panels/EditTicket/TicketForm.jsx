...
class TicketForm extends React.Component {
  ...
  makeTicketSolved(response) {
      ...
      return fetch('http://otapi.lbr.lu/api/ot/ticket/' + response.ticket, {
        method: 'PUT',
  ...
  linkEventToTicket(ticketid, eventid) {
    ...
    return fetch('http://otapi.lbr.lu/api/ot/event/' + eventid, {
      method: 'PUT',
      body: JSON.stringify(query),
      headers: {
        'Accept': 'application/json',
  ...
  saveClient(){
    ...
    return fetch('http://otapi.lbr.lu/api/ot/clients', {
      method: 'PUT',
  ...
  handleTicketSubmit = (e) => {
    ...
    return fetch('http://otapi.lbr.lu/api/ot/tickets', {
      method: 'PUT',
